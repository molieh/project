...
**2. Print quality plot or chart as requested in scenario**
...
```{r}
scatter_plot <- ggplot(data = total_dataset, aes(x = sex_female,
                                                 y = total_mpx_case)) + 
...
scatter_plot
scatter_plot <- ggplot(data = total_dataset, aes(x = sex_male,
                                                 y = total_mpx_case)) + 
  geom_point(na.rm=TRUE) + theme_minimal(base_size = 15)+
