...
```{r}
#aggregating the monkey pox data set to the desired time period (week or month)& renaming the country code so that we can merge with pop denominator dataset 
monkey_pox
